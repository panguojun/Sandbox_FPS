...
public class TriangleArt : MonoBehaviour
{
    ...
    public void createTriangle(Ray ray, int type)
    {
            ...
            return;
        {
            ...
            {// 由三角形索引得到方形面     
                ...
                {// 合法性判定
                    ...
                    Plane hitplane = new Plane(-Camera.main.transform.forward, transform.TransformPoint(p1));//, transform.TransformPoint(p2), transform.TransformPoint(p3));
                    float enter;
                    if (hitplane.Raycast(ray, out enter))
                    {
                        ...
                        else
                        {
                            ...
                            int edited = PMDLL.triangleArt(type, vertices, vertices.Length, triangles, triangles.Length, mesh0.colors32, hittriangleIndex,
    ...
    void OnGUI()
    {
        ...
        {            
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                if (getpos(ray, 0))
                {
                    Common.settreated(true, gameObject, 23);
            ...
            else if (Input.GetMouseButtonUp(0) && lstmousedownsucc)
            {
                ...
                else
                {
                    ...
                    portalbox.SendMessage("addtrioper", gameObject);
                }
